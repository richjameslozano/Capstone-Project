...
//         doc.setFont("helvetica", "bold");
//         doc.setFontSize(16);
//         doc.text("APPROVED RESTOCK REQUESTS REPORT", pageWidth / 2, headerTopY + 5, { align: "center" });
...
//         doc.setFontSize(11);
//         doc.text(asOfString, pageWidth / 2, headerTopY + 12, { align: "center" });
...
//       doc.setFont("helvetica", "bold");
//       doc.setFontSize(12);
//       doc.text("Report Details", marginX, reportDetailsY);
...
//       doc.line(marginX, y + 12, marginX + blockWidth, y + 12);
//       doc.setFontSize(9);
//       doc.text("(Signature over printed name & date)", marginX, y + 17);
//       doc.setFont("helvetica", "bold");
//       doc.setFontSize(10);
...
//       doc.line(rightX, y + 12, rightX + blockWidth, y + 12);
//       doc.setFontSize(9);
//       doc.text("(Signature over printed name & date)", rightX, y + 17);
