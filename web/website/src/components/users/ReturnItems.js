...
//     console.log("🔧 INITIALIZED ITEM CONDITIONS:", initialItemConditions);
...
//       usageType: selectedRequest.raw?.usageType || "N/A",
//       requestList: (selectedRequest.raw?.requestList || []).map((item) => {
//         console.log("🔍 PROCESSING ITEM FOR RETURN (WEB):");
//         console.log("  itemName:", item.itemName);
//         console.log("  category:", item.category);
//         console.log("  itemIdFromInventory:", item.itemIdFromInventory);
//         console.log("  itemUnitConditions:", itemUnitConditions);
        
//         // For equipment items, use individual QR code logic
//         if (item.category === "Equipment") {
//           console.log("🔧 EQUIPMENT ITEM RETURN (WEB):");
...
//           // Create individualQRConditions for equipment items
//           const individualQRConditions = conditions.map((condition, index) => ({
//             qrCodeId: `placeholder-${index}`,
//             individualItemId: `${item.itemIdFromInventory}${String(index + 1).padStart(2, '0')}`,
//             condition: condition
//           }));
...
//         console.log("🔧 CALLING INDIVIDUAL QR CODE RETURN ENDPOINT (WEB):");
//         console.log("  itemId:", item.itemIdFromInventory);
//         console.log("  individualQRConditions:", individualQRConditions);
...
//             console.log("✅ Returned individual QR codes (WEB):", returnData);
...
//                        console.log("🔧 EQUIPMENT RETURN BUTTON DEBUG:");
//                        console.log("  itemId:", itemId);
//                        console.log("  item.quantity:", item.quantity);
//                        console.log("  itemConditions:", itemConditions);
//                        console.log("  generated conditions:", conditions);
//                        console.log("  newItemUnitConditions:", newItemUnitConditions);
//                     } else {
...
//               {/* OLD EQUIPMENT SECTION - COMMENTED OUT */}
//               {/* {equipmentData.length > 0 && (
//                 <>
//                   <Typography.Title level={4} style={{ marginTop: 24 }}>
//                     Equipment
...
//                           itemName: `${item.itemName} #${unitIndex + 1}`,
//                           unitId: `${item.itemIdFromInventory}${String(unitIndex + 1).padStart(2, '0')}`,
...
//                           console.log("🔍 CONDITION SELECT DEBUG:");
...
//                                 console.log("  record.itemId:", record.itemId);
//                                 console.log("  record.unitIndex:", record.unitIndex);
...
//                                     [conditionKey]: value,
//                                   };
//                                   console.log("  Updated itemConditions:", newState);
//                                   return newState;
//                                 });
...
//                                   };
//                                   console.log("  Updated itemUnitConditions:", newState);
//                                   return newState;
//                                 });
//                               }}
//                               disabled={isDisabled}
